...
public class ModScreenHandlers {
    ...
    public static void registerModScreenHandlers(){
        ...
        STEEL_FURNACE_SCREEN_HANDLER = Registry.register(Registries.SCREEN_HANDLER, Identifier.of("subterra", "alloy_furnace"), new ScreenHandlerType<>(SteelFurnaceScreenHandler::new, FeatureFlags.VANILLA_FEATURES));
    }
}
